 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query LatestMerchants {\n  latestMerchants(limit: 20) {\n    id\n    name\n    updatedAt\n    __typename\n  }\n}"): (typeof documents)["query LatestMerchants {\n  latestMerchants(limit: 20) {\n    id\n    name\n    updatedAt\n    __typename\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation SummarizeMerchant($id: ID!) {\n  summarizeMerchant(id: $id) {\n    id\n    summaryText\n    confidence\n    __typename\n  }\n}"): (typeof documents)["mutation SummarizeMerchant($id: ID!) {\n  summarizeMerchant(id: $id) {\n    id\n    summaryText\n    confidence\n    __typename\n  }\n}"];
